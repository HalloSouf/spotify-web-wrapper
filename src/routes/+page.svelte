<svelte:head>
	<title>SpotiWeb - Developing</title>
</svelte:head>
	...
	<div class="text-center w-1/2">
		...
		<p class="text-xl mt-5">
			...
			<a
				target="_blank"
				rel="noreferrer"
				class="underline decoration-sky-600 decoration-dotted underline-offset-2 hover:text-sky-700"
				href="https://github.com/HalloSouf/spotify-web-wrapper"
				>https://github.com/HalloSouf/spotify-web-wrapper</a
			>.
		</p>
	</div>
</div>
